...
@section('content')
            ...
            <div class="col-sm-3">
                <div class="card" style="width:400px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="color: black; font-weight: bold">This hospital is 24 hours open. Medical shops are also open in night</p>
            ...
            <div class="col-sm-3">
                <div class="card" style="width:400px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="color: black; font-weight: bold">Separate doctors are in duty in day and night shift. Nurse is also take care patients.</p>
                        <a href="#" class="btn btn-dark">See More</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width:400px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="color: black; font-weight: bold">Cost will be free when meet the doctor at the second time. No visiting charge will be appiled.</p>
                        <a href="#" class="btn btn-dark">See More</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width:400px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="color: black; font-weight: bold">Every single room have twich bed and an assistant for patient</p>
                        <a href="#" class="btn btn-dark">See More</a>
                    </div>
                </div>
            </div>
    ...
    <section class="jumbotron" id="testimonial">
                        ...
                        <div class="card">
                            <div class="layer">
                                <div class="content">
                                    ...
                                    <div class="imgBx">
                                        <img src="{{asset('images/jbackground.jpg')}}}" alt="">
                                    </div>
                                    <div class="details">
                                        <h2>Somthing here <br><span>Something here 2</span></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
